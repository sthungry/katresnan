...
const targetStr = `            <p style={{ fontFamily: "'Work Sans',sans-serif", fontSize: '0.82rem', color: C.muted, lineHeight: 1.9, maxWidth: 420, margin: '0 auto' }}>
...
const replaceStr = `            <p style={{ fontFamily: "'Work Sans',sans-serif", fontSize: '0.82rem', color: C.muted, lineHeight: 1.9, maxWidth: 420, margin: '0 auto' }}>
              {preset.sub}
            </p>
          </>
        )}
