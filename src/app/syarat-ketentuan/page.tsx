    ...
    <div className="min-h-screen bg-[#fffde8] dark:bg-[#0f1a13]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
            ...
            <div key={s.num} className="bg-white dark:bg-[#1a2e1d] border border-[#ffdce2] dark:border-[#2a4a38] rounded-2xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col items-center gap-1.5 flex-shrink-0">
                  <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#ffdce2] to-[#fff5c0] dark:from-[#1a3028] dark:to-[#2a4a38] flex items-center justify-center text-base">
                    {s.icon}
                  </div>
                  <span className="text-[10px] font-bold text-[#8a9e8c] dark:text-[#5a9e80]">0{s.num.length === 1 ? s.num : s.num}</span>
                </div>
                        ...
                        <li key={i} className="flex items-start gap-2.5 text-sm text-[#6b8f72] dark:text-[#7aaa90]">
                          <span className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 text-[10px] font-bold ${
                            s.listType === 'forbidden'
                              ? 'bg-[#fce4ec] dark:bg-[#3a1a20] text-[#e8879a]'
                              : 'bg-[#ffdce2] dark:bg-[#2a4a38] text-[#e8879a] dark:text-[#4ecdc4]'
                          }`}>
                            {s.listType === 'forbidden' ? '✕' : '✓'}
                          </span>
                          {item}
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-3">
          ...
          <Link href="/kebijakan-privasi" className="flex-1 bg-[#03554e] dark:bg-[#1a5c52] text-white font-semibold px-6 py-3 rounded-full text-sm text-center hover:bg-[#023d38] transition-colors">
