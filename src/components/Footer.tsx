...
<<<<<<< HEAD
  ...
  Informasi: [
    ...
    { label: 'Blog',         href: '#' },
=======
    { label: 'Undangan Ulang Tahun', href: '/demo?paket=gold' },
    { label: 'Undangan Pertunangan', href: '/demo?paket=gold' },
    { label: 'Undangan Khitanan',   href: '/demo?paket=silver' },
    { label: 'Undangan Wisuda',     href: '/demo?paket=silver' },
  ],
  Informasi: [
    { label: 'Tentang Kami', href: '#' },
    { label: 'Portfolio',    href: '/demo' },
    { label: 'Blog',         href: '#' },
    { label: 'Karir',        href: '#' },
    { label: 'Press',        href: '#' },
...
export default function Footer() {
  ...
  return (
<<<<<<< HEAD
    <footer id="kontak" className="bg-sage-800 dark:bg-sage-950">
      {/* CTA Banner */}
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="relative bg-white/5 backdrop-blur rounded-3xl p-10 md:p-14 text-center overflow-hidden border border-white/10">
          {/* Background glow */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[200px] bg-gold-500/5 blur-[100px]" />
          ...
          <div className="relative z-10">
            ...
            <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-white/5 border border-white/10 flex items-center justify-center">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-7 h-7 text-gold-400">
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-bold text-white mb-3">
              ...
              <span className="text-gold-300">Tak Terlupakan Selamanya</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/#harga" className="bg-gradient-to-r from-gold-500 to-gold-400 text-white hover:shadow-lg hover:shadow-gold-500/25 font-semibold px-8 py-3.5 rounded-full transition-all text-sm">
                Pesan Sekarang
              </Link>
...
=======
    <footer id="kontak" className="bg-[#03554e] dark:bg-[#071310]">
      {/* CTA Banner */}
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="relative bg-white/10 dark:bg-white/5 backdrop-blur rounded-3xl p-10 text-center overflow-hidden border border-white/20 dark:border-[#4ecdc4]/10">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[200px] bg-[#ffdce2]/10 dark:bg-[#4ecdc4]/5 blur-[80px]" />
          <div className="relative z-10">
            <div className="text-5xl mb-4">💍</div>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-3">
              Jadikan Hari Istimewa Anda<br />
              <span className="text-[#ffdce2] dark:text-[#4ecdc4]">Tak Terlupakan Selamanya</span>
            </h2>
            <p className="text-white/70 mb-8 max-w-lg mx-auto text-sm leading-relaxed">
              Ribuan pasangan telah mempercayakan momen paling berharga kepada kami. Sekarang giliran Anda.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/#harga" className="bg-white dark:bg-[#4ecdc4] text-[#03554e] hover:bg-[#ffdce2] dark:hover:bg-[#7fdeaa] font-bold px-8 py-3.5 rounded-full transition-all text-sm shadow-lg">
                🌸 Pesan Sekarang
              </Link>
              <a href="https://wa.me/6285150000715" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 border-2 border-white/40 hover:border-white text-white px-8 py-3.5 rounded-full transition-all text-sm">
>>>>>>> e40ea50899cb8afda9add57f89ef9938382b1835
...
=======
      <div className="max-w-6xl mx-auto px-6 pb-12 grid grid-cols-2 md:grid-cols-4 gap-10 border-t border-white/10 pt-10">
        {/* Brand */}
        <div className="col-span-2 md:col-span-1">
          <div className="mb-4">
            <KatresnanLogo variant="light" height={30} />
          </div>
          <p className="text-white/50 text-sm leading-relaxed mb-4">
            Platform undangan digital terpercaya untuk momen paling spesial dalam hidup Anda.
>>>>>>> e40ea50899cb8afda9add57f89ef9938382b1835
          </p>
...
=======
                className="w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white/70 hover:text-white transition-colors text-xs font-medium">
>>>>>>> e40ea50899cb8afda9add57f89ef9938382b1835
                {s.label}
              </a>
            ))}
...
=======
      <div className="border-t border-white/10 max-w-6xl mx-auto px-6 py-5 flex flex-col sm:flex-row justify-between items-center gap-3">
        <p className="text-white/40 text-xs">© {year} Katresnan. Hak cipta dilindungi.</p>
        <div className="flex items-center gap-4 text-xs">
          <Link href="/kebijakan-privasi" className="text-white/40 hover:text-white/70 transition-colors">
            Kebijakan Privasi
          </Link>
          <span className="text-white/20">·</span>
          <Link href="/syarat-ketentuan" className="text-white/40 hover:text-white/70 transition-colors">
            Syarat & Ketentuan
          </Link>
          <span className="text-white/20">·</span>
          <span className="text-white/40">Dibuat dengan 💕 di Indonesia</span>
>>>>>>> e40ea50899cb8afda9add57f89ef9938382b1835
        </div>
      </div>
    </footer>
