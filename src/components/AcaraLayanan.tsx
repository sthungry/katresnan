...
const weddingStyles = [
  {
    ...
    gradient: 'from-tertiary-100 to-tertiary-50 dark:from-tertiary-900/20 dark:to-slate-900/30',
  ...
  },
  {
    ...
    gradient: 'from-slate-100 to-slate-50 dark:from-slate-800/20 dark:to-slate-900/30',
  ...
  },
  {
    ...
    gradient: 'from-primary-100 to-primary-50 dark:from-primary-900/20 dark:to-slate-900/30',
  ...
  },
  {
    ...
    gradient: 'from-primary-100 to-surface-100 dark:from-primary-900/20 dark:to-slate-900/30',
  ...
  },
  {
    ...
    gradient: 'from-slate-100 to-surface-100 dark:from-slate-800/20 dark:to-slate-900/30',
  ...
  },
  {
    ...
    gradient: 'from-tertiary-100 to-primary-50 dark:from-tertiary-900/20 dark:to-slate-900/30',
...
export default function AcaraLayanan() {
  ...
  return (
    <section className="py-24 px-6 bg-surface-100 dark:bg-slate-950 transition-colors" ref={sectionRef}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {weddingStyles.map((style, i) => (
            <div key={style.title}
              className="animate-on-scroll card-hover group bg-white dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800 rounded-2xl p-6 cursor-pointer"
              ...
              <h3 className="font-serif font-semibold text-slate-800 dark:text-surface-200 text-lg mb-2">{style.title}</h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">{style.desc}</p>
            </div>
          ))}
        </div>
      </div>
